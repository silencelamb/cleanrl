...
from mapping_simple_action_mask_noorder_normalize_env import MappingSimpleActionMaskNoOderNormalizeEnv
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        ...
        env = MappingSimpleActionMaskNoOderNormalizeEnv(use_image=True)
